...
public class TelaContador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCont.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                btnContStateChanged(evt);
            }
        });
    ...
    private void btnContStateChanged(javax.swing.event.ChangeEvent evt) {                                     
        // TODO add your handling code here:
        int i = sliInicio.getValue();
        int f = sliFim.getValue();; 
        int p = sliPasso.getValue();;
